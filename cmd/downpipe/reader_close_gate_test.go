...
//
// The engine has the same rule enforced the same way, in test/validate-master-zeroisation.ts, and it was
// written first. Its findings were the reason to look here.
//
