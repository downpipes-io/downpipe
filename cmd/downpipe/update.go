...
// deploy-token scopes are NOT duplicated here; they live in engine/docs/CLOUDFLARE-PERMISSIONS.md
...
func updatePlan(version, engineDomain, consoleDomain string) string {
	...
	fmt.Fprintln(&b, "Full reference: engine/docs/CLOUDFLARE-PERMISSIONS.md, engine/docs/UPDATES.md and engine/docs/OPERATIONS.md.")
	fmt.Fprintln(&b, "")
...
func writeUpdateStep2ReElevate(b *strings.Builder) {
	...
	fmt.Fprintln(b, "  the same ones init prints; the canonical list is engine/docs/CLOUDFLARE-PERMISSIONS.md (do")
