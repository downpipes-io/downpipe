...
// RV-CLI-MARKER-RESTORED-VERBATIM: the end-to-end command proof. A real, signed, encrypted
...
// RV-CLI-MARKER-RECEIPT: the SIGNED restore receipt must surface the incompleteness-marker signal as
