...
//
// The plan follows the three privilege states documented in engine/docs/CLOUDFLARE-PERMISSIONS.md:
...
func initPlan(engineDomain, consoleDomain, zone, archiveBucket string) string {
	...
	fmt.Fprintln(&b, "Full reference: engine/docs/CLOUDFLARE-PERMISSIONS.md and engine/docs/OPERATIONS.md.")
	fmt.Fprintln(&b, "")
	...
	// engine/docs/CLOUDFLARE-PERMISSIONS.md.
