...
// TestRunRestorePartialFailureExitsNonZero covers DP-L14: when --apply is set and one or
...
// design. restore.go stopped doing that when INT-1/INT-4 was fixed: it propagates
...
// TestCmdSelftestWriterRoundTrip covers DP-L13: the selftest command exercises the
