...
// nearly all the real cross-implementation work behind the "held to agreement" claim
// (MOAT.7), and a corpus that silently shrank — one directory deleted, its
...
func TestConformance(t *testing.T) {
	...
	// is missing, not report success having compared nothing (MOAT.7 proved live that the
	// previous t.Skip made this exact mechanism pass vacuously on an empty testdata/vectors).
	var missing []string
