...
// true integrity verdict instead of always exiting 1 (INT-1/INT-4).
...
// is the verdict a `verify --deep` over a byte-flipped segment must surface — the exit code
// the swallowed-to-1 bug hid (INT-1).
